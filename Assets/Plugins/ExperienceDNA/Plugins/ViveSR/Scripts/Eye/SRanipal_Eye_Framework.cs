    ...
    namespace anipal
    {
        namespace Eye
        {
            public class SRanipal_Eye_Framework : MonoBehaviour
            {
                ...
                private static bool _isManagerNullAndHasNotBeenCommunicated = true;
                public static SRanipal_Eye_Framework Instance
                {
                    get
                    {
                        ...
                        if (Mgr == null)
                        {
                            if(_isManagerNullAndHasNotBeenCommunicated)
                                Debug.LogError("SRanipal_Eye_Framework not found");
                            _isManagerNullAndHasNotBeenCommunicated = false;
                        }
                        return Mgr;
                    }
                }
