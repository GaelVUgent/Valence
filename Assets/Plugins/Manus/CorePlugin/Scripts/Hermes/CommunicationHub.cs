	...
	public class CommunicationHub : MonoBehaviour
	{
		...
		void Connect()
		{
			...
			try
			{
				...
				m_Hive = HClient.Hive.FindLocalCoordinator("Hermes.Unity.Test", (int)HProt.DefaultPorts.HivePort, (_node) =>
				{
					...
					if (!m_CareTaker.Connect(_node.Coordinator, "Manus Unity Plugin", m_ApplicationString, OnFilterSetup))
